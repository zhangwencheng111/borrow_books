...
Page({
    ...
    shareBook:function(){
        ...
        wx.request({
            url: 'https://' + app.globalData.apiUrl + '/bookshare?m=home&c=Api&a=shareBook&ownerId=' + app.globalData.userId + "&bookId=" + that.data.bookId + "&keep_time=" + that.data.uploadDays + "&location=" + that.data.location + "&longitude=" + that.data.longitude + "&latitude=" + that.data.latitude,
            method: "GET",
            header: {
                'content-type': 'application/json'
            },
