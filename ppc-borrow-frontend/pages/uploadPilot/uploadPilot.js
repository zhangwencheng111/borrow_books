                    ...
                    wx.scanCode({
                        success: (res) => {
                            if (res.errMsg == "scanCode:ok") {
                                ...
                                wx.request({
                                    url: 'https://' + app.globalData.apiUrl + '/bookshare?m=home&c=Api&a=insertPilot&user_id=' + app.globalData.userId + "&qrcode_id=" + qrcodeId + "&can_share_id=" + that.data.can_share_id,
                                    method: "GET",
                                    header: {
                                        'content-type': 'application/json'
                                    },
                    ...
                    wx.scanCode({
                        success: (res) => {
                            if (res.errMsg == "scanCode:ok") {
                                ...
                                wx.request({
                                    url: 'https://' + app.globalData.apiUrl + '/bookshare?m=home&c=Api&a=updateOwner&pilot_id=' + array[0] + "&bookcase_qrcode=" + array[1] + "&can_share_id=" + that.data.can_share_id,
                                    method: "GET",
                                    header: {
                                        'content-type': 'application/json'
                                    },
